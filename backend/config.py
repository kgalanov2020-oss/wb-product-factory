...
class Settings(BaseSettings):
    ...
    mpstats_email_selector: str | None = None
    mpstats_password_selector: str | None = None
    mpstats_submit_selector: str | None = None
    ...
    def mpstats_login_configured(self) -> bool:
        return bool(
            self.mpstats_email
            and self.mpstats_password
            and self.mpstats_email_selector
            and self.mpstats_password_selector
            and self.mpstats_submit_selector
        )
